...
Version  : 3.1.6
Release  : 29
URL      : https://github.com/AcademySoftwareFoundation/openexr/archive/v3.1.6/openexr-3.1.6.tar.gz
Source0  : https://github.com/AcademySoftwareFoundation/openexr/archive/v3.1.6/openexr-3.1.6.tar.gz
...
%prep
%setup -q -n openexr-3.1.6
cd %{_builddir}/openexr-3.1.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678729575
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libIex-3_1.so.30.6.1
/usr/lib64/libIlmThread-3_1.so.30
/usr/lib64/libIlmThread-3_1.so.30.6.1
/usr/lib64/libOpenEXR-3_1.so.30
/usr/lib64/libOpenEXR-3_1.so.30.6.1
/usr/lib64/libOpenEXRCore-3_1.so.30
/usr/lib64/libOpenEXRCore-3_1.so.30.6.1
/usr/lib64/libOpenEXRUtil-3_1.so.30
/usr/lib64/libOpenEXRUtil-3_1.so.30.6.1
