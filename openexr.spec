...
Version  : 3.0.4
Release  : 23
URL      : https://github.com/AcademySoftwareFoundation/openexr/archive/v3.0.4/openexr-3.0.4.tar.gz
Source0  : https://github.com/AcademySoftwareFoundation/openexr/archive/v3.0.4/openexr-3.0.4.tar.gz
...
%prep
%setup -q -n openexr-3.0.4
cd %{_builddir}/openexr-3.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622763210
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/openexr-3.0.4/LICENSE.md %{buildroot}/usr/share/package-licenses/openexr/bb1da2f934217470d772d2a42fc838fe268e3eb9
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libIex-3_0.so.28
/usr/lib64/libIex-3_0.so.28.1.0
/usr/lib64/libIlmThread-3_0.so.28
/usr/lib64/libIlmThread-3_0.so.28.1.0
/usr/lib64/libOpenEXR-3_0.so.28
/usr/lib64/libOpenEXR-3_0.so.28.1.0
/usr/lib64/libOpenEXRUtil-3_0.so.28
/usr/lib64/libOpenEXRUtil-3_0.so.28.1.0
